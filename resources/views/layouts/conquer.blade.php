...
<body class="page-header-fixed">
            ...
            <div class="page-sidebar navbar-collapse collapse">
                ...
                <ul class="page-sidebar-menu">
                    ...
                    <li>
                        <a href="javascript:;">
                            <i class="icon-home"></i>
                            <span class="title">Master Report</span>
                            <span class="arrow "></span>
                        </a>
                        <ul class="sub-menu">
                            <li>
                                <a href="{{ url('/report/listmedicinesinnerjoin') }}">
                                    Medicines and categories</a>
                            </li>
                            <li>
                                <a href="{{ url('/report/categoryhasmedicines') }}">
                                    Categories that has medicines</a>
                            </li>
                            <li>
                                <a href="{{ url('/report/categorydonthavemedicines') }}">
                                    Categories that has no medicines</a>
                            </li>
                            <li>
                                <a href="{{ url('/report/averagepriceforeachcategory') }}">
                                    Average price each categories</a>
                            </li>
                            <li>
                                <a href="{{ url('/report/categoryThatHas1Product') }}">
                                    Categories that has one medicines</a>
                            </li>
                            <li>
                                <a href="{{ url('/report/showMedicineHasOneForm') }}">
                                    Medicines that has one form</a>
                            </li>
                            <li>
                                <a href="{{ url('/report/showMedicinesHasMostExpensivePrice') }}">
                                    Medicines with highest price</a>
                            </li>
                        </ul>
                    </li>
                </ul>
    ...
    <script src="{{ asset('assets/plugins/jquery.editable.js')}}" type="text/javascript"></script>
