<form method="POST" action="{{ route('obat.update', $data->id) }}">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="eGenericName" value="{{ $data->generic_name }}"
                name="generic_name" placeholder="Enter Generic Name">
        </div>
        <div class="form-group">
            <label for="InputForm">Form</label>
            <input type="text" class="form-control" id="eForm" value="{{ $data->form }}" name="form"
                placeholder="Enter Form">
        </div>
        <div class="form-group">
            <label for="InputRestricitonFormula">Restriction Formula</label>
            <input type="text" class="form-control" id="eResForm"
                value="{{ $data->restriction_formula }}" name="restricition_formula"
                placeholder="Enter Restriction Formula">
        </div>
        <div class="form-group">
            <label for="InputPrice">Price</label>
            <input type="text" class="form-control" id="ePrice" value="{{ $data->price }}" name="price"
                placeholder="Enter Price">
        </div>
        <div class="form-group">
            <label for="InputDescription">Description</label>
            <textarea class="form-control" id="eDesc" value="{{ $data->description }}" name="description"
                rows="3"></textarea>
        </div>
        <div class="form-group">
    ...
    <div class="modal-footer">
        <button type="button" onclick="saveDataUpdateTD({{ $data->id }})" data-dismiss="modal" class="btn btn-primary">Edit</button>
